...
<main id="pages">
        <article>
            ...
            <a href="{{ site.github.url }}/hire-sebastian/" title="Enquire about hiring me for your project"><button class="more"><i class="fa fa-chevron-left"></i> Back to Project Enquiry</button></a>
