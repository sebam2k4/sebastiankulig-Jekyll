...
<main id="pages">
        <article>
            ...
            <a href="{{ site.github.url }}/hire-sebastian/" title="Enquire about hiring me for your project"><button class="more">Available to work on your project <i class="fa fa-chevron-right"></i></button></a>
         
           
            <div class="content">
                <img id="self" src="{{ site.github.url }}/img/Sebastian-pic2.jpg" alt="">
                ...
                <p id="conclusion">I'd love to help you build a professional, beautiful, and functional website that will fit your needs. Visit my <a href="{{ site.github.url }}/">portfolio</a> for samples of my work or <a href="{{ site.github.url }}/hire-sebastian/">tell me aobut your project.</a></p>
            </div>
            
            
            <a href="{{ site.github.url }}/" title="Explore my Front-end decelopment portfolio"><button class="more">My Portfolio <i class="fa fa-chevron-right"></i></button></a>
        </article>
    </main>
