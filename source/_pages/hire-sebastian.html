...
<main id="pages">
        <article>
            ...
            <a href="{{ site.github.url }}/contact/" title="General Enquiry"><button class="more">General enquiry? <i class="fa fa-chevron-right"></i></button></a>
            
            <div class="content">
                <p>Please fill out the form below to enquire about hiring me for your project. To find out more about what I do, refer to my <a href="{{ site.github.url }}/about/">about page,</a> and to see some of my recent work, check out my <a href="{{ site.github.url }}/">portfolio.</a></p>
