...
<main>
        ...
        <a href="{{ site.github.url }}/hire-sebastian/" title="Enquire about hiring me for your project"><button id="portfolio-scroll" class="more">Hire me <i class="fa fa-chevron-right"></i></button></a>

        <section id="portfolio">
            <h2>Portfolio</h2>
            <figure id="westcoastkitchen">
                <a href="{{ site.github.url }}/portfolio/west-coast-kitchen/">
                ...
                <a href="{{ site.github.url }}/portfolio/rosewater/">
                    <div class="portfolio-item">
                ...
                <a href="{{ site.github.url }}/portfolio/currys-cake-angels/">
                    <div class="portfolio-item">
                ...
                <a href="{{ site.github.url }}/portfolio/2k-carpentry/">
                    <div class="portfolio-item">
        ...
        <a href="{{ site.github.url }}/about/" title="Learn more about me and my skills"><button class="more">About me <i class="fa fa-chevron-right"></i></button></a>
